...
- Expressions produce values, whereas statements are bigger pieces of code which do not produce a value. Examples of statements are 'if else statements' and 'switch statements'. Statements end in semi-colons. 
